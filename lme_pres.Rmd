...
- The Fixed Effect is Treatment. Other fixed effects may include age, gender, weight, etc. If we were to replicate this study, we would use these variables again.  

- The Random Effect(s) *are associated* with Patients. Each patient may randomly affect one or more of the fixed effects. If we were to replicate this study, we would not use the same patients again. 
...
- The Random Effect(s) *are associated* with Teachers and Schools. Each school and teacher may randomly affect one or more of the fixed effects. If we were to replicate this study, we would not necessarily use the same teachers and schools again. 
...
In our first example, we had longitudinal data grouped by patient, with multiple observations on the same patient. The effect of the patient is random. The effect of the treatment is a fixed effect.

In our second example, we had clustered data grouped by schools and teachers within schools. The effect of the schools and teachers within schools are random. The effect of the curriculum is a fixed effect.
