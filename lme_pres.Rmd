...
**Random effects** are associated with individual units drawn at random from a population. (eg: subjects, teachers, schools, plots of land, etc.) We can think of these units as *non-repeatable* levels of factors. If we repeat the analysis or experiment on new data, we would not use the same individual units.
