...
**Fixed effects** are the things you usually put in a regression model, such as gender, age, treatment, race, temperature, grade level, income, SAT score, etc, etc. We want to understand how they affect our dependent variable. _They produce regression coefficients._

**Random effects** are things that affect fixed effects. Examples include individuals, teachers, schools, rats, patients, plots of land, etc. We want to understand how their variation affects our fixed effects. _They produce estimates of variance, not regression coefficients._
